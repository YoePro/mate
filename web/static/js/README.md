...
This folder contains vanilla JavaScript for the MATE frontend.
...
- `graph.js` manages graph state.
- `nodes.js` creates and updates visual nodes.
- `links.js` creates and updates visual links.
- `toolbox.js` manages the toolbox.
